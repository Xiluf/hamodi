...
public class AddProductActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if(view.getId()==R.id.btUpdate){
            ...
            p.setGameName(etname.getText().toString());
            p.setProdDisc(etdisc.getText().toString());
            p.setGameprice(Double.parseDouble(etbuyprice.getText().toString()));
            p.setSaleprice(Double.parseDouble(etsaleprice.getText().toString()));
            p.setQuantity(Integer.parseInt(etstock.getText().toString()));
            if(SelectedNewImage)
